...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20220220082745_ProductUpdateInfo")]
    partial class ProductUpdateInfo
    {
            ...
            modelBuilder.Entity("WebApplication1.Models.BloodGroupInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 20, 12, 27, 45, 158, DateTimeKind.Local), IsActive = true, Name = "A+" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.DepartmentInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 20, 12, 27, 45, 136, DateTimeKind.Local), IsActive = true, Name = "Accounting" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.DesignationInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 20, 12, 27, 45, 144, DateTimeKind.Local), IsActive = true, Name = "Driver" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.EmployeeInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Address = "jos 10 faren street s6, no 1099", Age = 25, BloodGroupId = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 20, 12, 27, 45, 162, DateTimeKind.Local), DateofBirth = new DateTime(2022, 2, 20, 12, 27, 45, 162, DateTimeKind.Local), DepartmentId = 1, Description = "this is test Employee From Seed", DesignationId = 1, EmailAddress = "test@gmail.com", EmergencyContactNumber = "64648464412", GenderId = 1, HireDate = new DateTime(2022, 2, 20, 12, 27, 45, 163, DateTimeKind.Local), ImageUrl = "jas.jpg", IsActive = true, MobileNumber = "1231464612", Name = "Test Name" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.ProductInfo", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 20, 12, 27, 45, 151, DateTimeKind.Local), Description = "this is from seed,for test purpose", IsActive = true, Name = "Letter", UnitId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.TrackUpdateInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AfterUpdate = "Driver Name", BeforeUpdate = "Driver", CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 20, 12, 27, 45, 166, DateTimeKind.Local), IsActive = true, UpdateInfo = "Driver Update to Driver Name" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.UnitInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 20, 12, 27, 45, 148, DateTimeKind.Local), IsActive = true, Name = "Letter" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.UserInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2022, 2, 20, 12, 27, 45, 135, DateTimeKind.Local), FullName = "Admin", GenderId = 1, IsActive = true, UserName = "admin@gmail.com", UserPassword = "12345678" }
                    );
                });
