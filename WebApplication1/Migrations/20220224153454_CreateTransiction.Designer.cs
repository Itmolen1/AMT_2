...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20220224153454_CreateTransiction")]
    partial class CreateTransiction
    {
            ...
            modelBuilder.Entity("WebApplication1.Models.AccountsInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AccountTitle = "Petty cash", Code = 10001, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 553, DateTimeKind.Local), HeadAccountId = 1, IsActive = true }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.BloodGroupInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 538, DateTimeKind.Local), IsActive = true, Name = "A+" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.ControlAccountInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = 1001, ControlAccountName = "ASSETS", CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 547, DateTimeKind.Local), IsActive = true }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.CustomerInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Address = "nest 18, street k5 Allon", Area = "Mufraq", CompanyName = "Test Name", ContactPersonName = "Seed Name", Country = "UAE", CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 535, DateTimeKind.Local), Description = "this is test description from seed", Email = "this@test.com", IsActive = true, LandLine = "34564613564", MobileNumber = "121313454112", State = "Abu Dhabi", TRNNumber = "123456789123456" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.DepartmentInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 519, DateTimeKind.Local), IsActive = true, Name = "Accounting" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.DesignationInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 526, DateTimeKind.Local), IsActive = true, Name = "Driver" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.EmployeeInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Address = "jos 10 faren street s6, no 1099", Age = 25, BloodGroupId = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 542, DateTimeKind.Local), DateofBirth = new DateTime(2022, 2, 24, 19, 34, 53, 542, DateTimeKind.Local), DepartmentId = 1, Description = "this is test Employee From Seed", DesignationId = 1, DrivingLicienceExpiry = new DateTime(2022, 2, 24, 19, 34, 53, 543, DateTimeKind.Local), EmailAddress = "test@gmail.com", EmergencyContactNumber = "64648464412", GenderId = 1, HireDate = new DateTime(2022, 2, 24, 19, 34, 53, 542, DateTimeKind.Local), IdCardExpiry = new DateTime(2022, 2, 24, 19, 34, 53, 542, DateTimeKind.Local), ImageUrl = "jas.jpg", IsActive = true, MobileNumber = "1231464612", Name = "Test Name", PassportExpiry = new DateTime(2022, 2, 24, 19, 34, 53, 543, DateTimeKind.Local), VisaExpiry = new DateTime(2022, 2, 24, 19, 34, 53, 543, DateTimeKind.Local) }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.HeadAccountsInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = 1001, ControlAccountId = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 550, DateTimeKind.Local), HeadAccountTitle = "Current Assets", IsActive = true }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.ProductInfo", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 531, DateTimeKind.Local), Description = "this is from seed,for test purpose", IsActive = true, Name = "Letter", UnitId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.TrackUpdateInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AfterUpdate = "Driver Name", BeforeUpdate = "Driver", CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 544, DateTimeKind.Local), IsActive = true, UpdateInfo = "Driver Update to Driver Name" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.TransictionInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AccountId = 2, Cr = 0f, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 556, DateTimeKind.Local), Description = "Owner invest as a cash", Dr = 5000f, ForDate = new DateTime(2022, 2, 24, 19, 34, 53, 556, DateTimeKind.Local), IsActive = true },
                        new { Id = 2, AccountId = 1020, Cr = 5000f, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 556, DateTimeKind.Local), Description = "Owner invest as a cash", Dr = 0f, ForDate = new DateTime(2022, 2, 24, 19, 34, 53, 556, DateTimeKind.Local), IsActive = true }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.UnitInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 528, DateTimeKind.Local), IsActive = true, Name = "Letter" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.UserInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 519, DateTimeKind.Local), FullName = "Admin", GenderId = 1, IsActive = true, UserName = "admin@gmail.com", UserPassword = "12345678" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.VehicleInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Brand = "Toyota", Color = "Red", Comments = "this from seed for test", CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 526, DateTimeKind.Local), InsuranceExpiry = new DateTime(2022, 2, 24, 19, 34, 53, 526, DateTimeKind.Local), IsActive = true, Model = "2008", MulkiyaExpiry = new DateTime(2022, 2, 24, 19, 34, 53, 526, DateTimeKind.Local), PlateNumber = "2005", RegisterdRegion = "Abu Dhabi", TCNumber = "13131", VehicleTypeId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.VehicleTypeInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 538, DateTimeKind.Local), IsActive = true, TypeName = "Heavy Vehicle" }
                    );
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.VenderInformations", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Address = "nest 18, street k5 Allon", Area = "Mufraq", CompanyName = "Test Vender", ContactPersonName = "Seed Vender", Country = "UAE", CreatedBy = 1, CreatedDate = new DateTime(2022, 2, 24, 19, 34, 53, 538, DateTimeKind.Local), Description = "this is test description from seed", Email = "this@test.com", IsActive = true, LandLine = "34564613564", MobileNumber = "121313454112", State = "Abu Dhabi", TRNNumber = "123456789123456" }
                    );
                });
